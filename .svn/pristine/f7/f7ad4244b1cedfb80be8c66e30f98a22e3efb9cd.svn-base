...
public class ConnectShell extends JPanel{
	...
	private static ConnectShell window = null;	
		...
		start.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					DatagramSocket ds = new DatagramSocket(Integer.parseInt(textUDPport
							.getText()));			
					...
					new MyClient(ds,id,userName,tankType,isMaster,TCP_IP,TCP_PORT,TCP_PORT2);
